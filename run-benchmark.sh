...
CLIM_LOCATION='/home/data/extreme_167.grib'
...
for config in configs/*window24.yaml;
    ...
    python scripts/run_benchmark_classic.py --image "docker.io/jinmannwong/pproc-kubernetes:file" --image_secret regcred --output_dir $RUN_OUTPUT_DIR --config config_temp.yaml --ensemble fileset:ens --climatology fileset:clim | tee $RUN_OUTPUT_DIR/console.log
